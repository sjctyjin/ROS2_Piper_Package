...
class EnhancedDualArmTracker(Node):
    ...
    def setup_original_parameters(self):
        ...
        # 左右手臂配置
        self.declare_parameter('left_arm_config', 'trip_piper_left_with_car.yml')
        self.declare_parameter('right_arm_config', 'trip_piper_right_with_car.yml')
        ...
        self.declare_parameter('arm2_offset_z', 0.22)
        ...
        try:
            ...
            if target_frame == 'cam3_object_frame':
                pose = Pose.from_list([
                    ...
                    self.arm2_gripper_bag[0]-0.02, self.arm2_gripper_bag[1]+0.06, self.arm2_gripper_bag[2],
                ...
                if tf_result is not None:
                    ...
                    if (self.target_position is None or 
                        ...
                        arm2_target_pose = Pose.from_list([
                            ...
                            arm2_pos[0], arm2_pos[1]-0.1, arm2_pos[2]-0.1,
                            0.708,-0.070, 0.699, 0.071
            ...
            # if self.arm1_mpc_completed == True and self.arm2_mpc_completed == True:
                ...
                for attempt in range(max_attempts):
                    ...
                    if current_arm1_pos is not None and current_arm2_pos is not None:
                        ...
                        arm1_grasped = 0.02 < abs(current_arm1_pos) < 0.037  # 調整這些閾值
                        arm2_grasped = 0.02 < abs(current_arm2_pos) < 0.037
